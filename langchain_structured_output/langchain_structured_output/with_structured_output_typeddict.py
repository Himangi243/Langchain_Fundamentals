...
class Review(TypedDict):
    key_themes:Annotated[list[str],"write down all the key themes discussed in the reveiw in a list"]
    summary:Annotated[str,"a brief summary ofthe   reveiw"]
    sentiment:Annotated[Literal["pos","neg"],"return sentiment of the reveiw either negative ,positive or neutral"]
    ...
    name:Annotated[Optional[str],"write the name of the reveiwer"]
